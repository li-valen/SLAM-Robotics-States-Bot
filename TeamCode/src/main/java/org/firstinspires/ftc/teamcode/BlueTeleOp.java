...
public class BlueTeleOp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence blueHang = drive.trajectorySequenceBuilder(myPose)
                .lineToLinearHeading(new Pose2d(-23.5, 57.5, Math.toRadians(0)))
                .waitSeconds(1)
        ...
        while(opModeIsActive()) {
            ...
            if(gamepad1.dpad_left){
                if(gamepad1.a){
                    drive.followTrajectorySequence(blueHang);
                }
            }
